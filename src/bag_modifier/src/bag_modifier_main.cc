...
void LoadOptions(const ros::NodeHandle& node,
...
int main(int argc, char** argv) {
  ...
  options.repaired_bag_path =
      keti::kadif::bag_modifier::MakeOutputPath(options.input_bag_path, suffix);
  options.interpolated_bag_path = keti::kadif::bag_modifier::MakeOutputPath(
